...
const CommentTable = ({commentData, approved}) => {
    ...
    return (
        <>
            <tr className='border-y-2 text-sm max-sm:text-xs max-sm:table-fixed max-sm:whitespace-nowrap'>
                <td className='py-4 px-2 flex flex-col items-start max-sm:py-2'>
